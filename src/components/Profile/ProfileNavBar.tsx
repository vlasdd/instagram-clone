...
const ProfileNavBar: React.FC = () => {
  ...
  return (
    <div className="flex border-t justify-center items-center border-t-gray-300 gap-12 lg:gap-16 text-[12px] font-medium tracking-widest w-full sm:w-3/4 lg:w-4/5 ">
                <button
                    onClick={() => {
