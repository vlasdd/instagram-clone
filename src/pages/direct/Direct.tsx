...
const Direct: React.FC = () => {
    ...
    return (
        <div className="back w-screen h-screen flex flex-col items-center ">
            <Header />
            <div className="flex flex-col sm:flex-row gap-16 sm:gap-0 bg-white w-full md:w-11/12 lg:w-4/5 xl:w-2/3 h-[calc(100vh-90px)] max-w-[935px] border-x border-b border-t my-3">
                {
                    innerWidth > 640 ?
                        <>
